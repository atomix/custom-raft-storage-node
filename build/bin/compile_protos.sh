...
protoc -I=$proto_imports --gogofaster_out=Matomix/raft/protocol/cluster.proto=github.com/atomix/atomix-raft-node/pkg/atomix/raft/protocol,Mgoogle/protobuf/duration.proto=github.com/gogo/protobuf/types,Mgoogle/protobuf/timestamp.proto=github.com/gogo/protobuf/types,import_path=atomix/raft/metadata,plugins=grpc:pkg pkg/atomix/raft/store/metadata/*.proto
