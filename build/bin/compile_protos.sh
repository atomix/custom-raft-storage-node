...
protoc -I=$proto_imports --gogofaster_out=Mgoogle/protobuf/duration.proto=github.com/gogo/protobuf/types,Mgoogle/protobuf/timestamp.proto=github.com/gogo/protobuf/types,import_path=atomix/raft/metadata,plugins=grpc:pkg pkg/atomix/raft/store/metadata/*.proto
