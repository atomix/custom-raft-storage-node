...
var fileDescriptor_0923bc181b6df334 = []byte{
	...
	,
...
func (this *TestValueSnapshot) Equal(that interface{}) bool {
	...
	that1, ok := that.(*TestValueSnapshot)
	if !ok {
		that2, ok := that.(TestValueSnapshot)
		if ok {
			that1 = &that2
		} else {
			return false
...
func NewPopulatedTestValueSnapshot(r randyTest, easy bool) *TestValueSnapshot {
	this := &TestValueSnapshot{}
	this.Value = string(randStringTest(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedSetRequest(r randyTest, easy bool) *SetRequest {
	this := &SetRequest{}
	this.Value = string(randStringTest(r))
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedSetResponse(r randyTest, easy bool) *SetResponse {
	this := &SetResponse{}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGetRequest(r randyTest, easy bool) *GetRequest {
	this := &GetRequest{}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGetResponse(r randyTest, easy bool) *GetResponse {
	this := &GetResponse{}
	this.Value = string(randStringTest(r))
	if !easy && r.Intn(10) != 0 {
	}
